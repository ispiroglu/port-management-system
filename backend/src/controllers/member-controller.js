...
const getWorkerLicenseFilter = async (request, response) => {
    try {
        var queryResult = await predefined.getWorkerLicenseFilter(request.query.hasLicense);
        console.log(queryResult);
        response.status(200).json(queryResult);
    } catch (error) {
        console.log(error);
